...
import com.example.demo.dao.master.FavoriteDao;
...
public class FavoriteServiceImpl implements FavouriteService {
    ...
    @Override
    public List<Favorite> showFavorite(String userName, int page, int size) {
        Pageable pageable = PageRequest.of(page,size);
        Page<Favorite> favorites = favoriteDao.findByUserNameIs(userName, pageable);
